...
const WalletExplanation = () => {
  return (
    <div>
      <p>
        <button className="btn btn-secondary" type="button" data-bs-toggle="collapse" data-bs-target="#walletExplanation" aria-expanded="false" aria-controls="collapseExample">
          Multi Sig Wallet Explanation
        </button>
      </p>
      <div className="collapse" id="walletExplanation">
        <div className={styles.imageDiv}>
          <Image src={WalletExplanationImg} layout="intrinsic"/>
        </div>
      </div>
    </div>
  );
